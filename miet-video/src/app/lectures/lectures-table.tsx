    ...
    return (
        <div className="lectures-table-wrapper">
            <div className="lectures-table">
                <LecturesTableItem videoRef="/player" previewRef="/miet.png" title="Lecture 1" date="18 Feb 2024"/>
                ...
                <LecturesTableItem videoRef="/player" previewRef="/next.svg" title="Lecture 4" date="18 Feb 2024"/>
                <LecturesTableItem videoRef="/player" previewRef="/../favicon.ico" title="Lecture 5" date="18 Feb 2024"/>
                <LecturesTableItem videoRef="/player" previewRef="/not_found.png" title="Lecture 6" date="18 Feb 2024"/>
                <LecturesTableItem videoRef="/player" previewRef="/../favicon.ico" title="Lecture 7" date="18 Feb 2024"/>
                <LecturesTableItem videoRef="/player" previewRef="/vercel.svg" title="Lecture 8" date="18 Feb 2024"/>
